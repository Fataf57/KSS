...
export default function Transiteur() {
  ...
  const handleSave = async () => {
    ...
    try {
      // Sauvegarder toutes les modifications du tableau (pour tous les utilisateurs)
      const errors: string[] = [];
  ...
  return (
    <DashboardLayout>
      ...
      <div className="flex flex-col h-full">
        ...
        <div className="flex-1 overflow-hidden flex flex-col min-h-0 -mt-3">
          {isLoading ? (
            ...
            <div className="bg-card rounded-xl border border-border overflow-hidden animate-fade-in flex-1 flex flex-col min-h-0 h-full">
              {/* Tableau unifié pour tous les utilisateurs */}
        ...
        {/* Bouton flottant pour ajouter des lignes */}
        <Button
          onClick={addRow}
